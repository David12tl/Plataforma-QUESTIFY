...
export default function ClassesPage() {
  ...
  // 1. fetchClases envuelto en useCallback para evitar el error de dependencias de ESLint
  ...
  // 2. useEffect con la dependencia corregida
  useEffect(() => {
    fetchClases();
  }, [fetchClases]);
              ...
              <div className="space-y-6">
                ...
                <div className="flex flex-col sm:flex-row gap-4 pt-4">
                  <button 
                    ...
                    className="flex-1 py-4 border-2 border-[#1c1917] font-black uppercase text-sm hover:bg-slate-100 transition-colors order-2 sm:order-1"
                  >
                    Cancelar
                  </button>
                  <button 
                    ...
                    disabled={loading}
                    className="flex-1 py-4 bg-[#1c1917] text-white font-black uppercase text-sm hover:bg-black transition-all order-1 sm:order-2 disabled:opacity-50"
                  >
